          ...
          >
            {menuItems.map((menuItem, index) => (
              <Link
                ...
                to={menuItem.url}
                role="tab"
                className={`tab ${activeMenuItem.includes(menuItem.url) ? " bg-emerald-500 border-none" : ""} w-auto md:w-fit h-fit px-4 py-2 border border-gray-500 text-xs md:text-sm flex flex-nowrap text-gray-100`}
