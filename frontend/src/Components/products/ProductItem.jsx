    ...
    <section className="bg-transparent">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-2 text-4xl font-light tracking-tight leading-none text-gray-900 md:text-5xl xl:text-5xl dark:text-white">
            {product.name}
          </h1>
          ...
          <div className="flex items-center justify-start space-x-4">
            <button
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-emerald-600 hover:bg-emerald-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
