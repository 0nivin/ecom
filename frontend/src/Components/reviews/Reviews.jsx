        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center max-w-xl mx-auto">
            ...
            <div className="text-center mb-10">
              <span className="inline-block w-1 h-1 rounded-full bg-emerald-500 ml-1" />
              <span className="inline-block w-3 h-1 rounded-full bg-emerald-500 ml-1" />
              <span className="inline-block w-40 h-1 rounded-full bg-emerald-500" />
              <span className="inline-block w-3 h-1 rounded-full bg-emerald-500 ml-1" />
              <span className="inline-block w-1 h-1 rounded-full bg-emerald-500 ml-1" />
            </div>
          </div>
